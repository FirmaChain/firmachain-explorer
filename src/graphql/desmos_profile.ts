    ...
    profile: Array<
        { __typename?: 'profile' } & Pick<Profile, 'address' | 'bio' | 'dtag' | 'nickname'> & {
                ...
                chainLinks: Array<
                    ...
                    } & { chainConfig: { __typename?: 'chain_link_chain_config' } & Pick<Chain_Link_Chain_Config, 'name'> }
                >;
                applicationLinks: Array<
                    { __typename?: 'application_link' } & Pick<Application_Link, 'username' | 'application'> & {
