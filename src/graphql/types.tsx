...
export type Coin_Array_Comparison_Exp = {
    /** is the array contained in the given array value */
    _contained_in?: Maybe<Array<Scalars['coin']>>;
    /** does the array contain the given value */
    _contains?: Maybe<Array<Scalars['coin']>>;
    _eq?: Maybe<Array<Scalars['coin']>>;
    _gt?: Maybe<Array<Scalars['coin']>>;
    _gte?: Maybe<Array<Scalars['coin']>>;
    _in?: Maybe<Array<Array<Scalars['coin']>>>;
    _is_null?: Maybe<Scalars['Boolean']>;
    _lt?: Maybe<Array<Scalars['coin']>>;
    _lte?: Maybe<Array<Scalars['coin']>>;
    _neq?: Maybe<Array<Scalars['coin']>>;
    _nin?: Maybe<Array<Array<Scalars['coin']>>>;
};
...
export type Community_Pool_Bool_Exp = {
    ...
    coins?: Maybe<Dec_Coin_Array_Comparison_Exp>;
    height?: Maybe<Bigint_Comparison_Exp>;
    one_row_id?: Maybe<Boolean_Comparison_Exp>;
};
...
export type Dec_Coin_Array_Comparison_Exp = {
    /** is the array contained in the given array value */
    _contained_in?: Maybe<Array<Scalars['dec_coin']>>;
    /** does the array contain the given value */
    _contains?: Maybe<Array<Scalars['dec_coin']>>;
    _eq?: Maybe<Array<Scalars['dec_coin']>>;
    _gt?: Maybe<Array<Scalars['dec_coin']>>;
    _gte?: Maybe<Array<Scalars['dec_coin']>>;
    _in?: Maybe<Array<Array<Scalars['dec_coin']>>>;
    _is_null?: Maybe<Scalars['Boolean']>;
    _lt?: Maybe<Array<Scalars['dec_coin']>>;
    _lte?: Maybe<Array<Scalars['dec_coin']>>;
    _neq?: Maybe<Array<Scalars['dec_coin']>>;
    _nin?: Maybe<Array<Array<Scalars['dec_coin']>>>;
};
...
export enum Double_Sign_Vote_Constraint {
    /** unique or primary key constraint on columns "block_id", "validator_address" */
...
export type Message_Bool_Exp = {
    ...
    involved_accounts_addresses?: Maybe<String_Array_Comparison_Exp>;
...
export enum Message_Constraint {
    /** unique or primary key constraint on columns "index", "transaction_hash", "partition_id" */
...
export enum Pre_Commit_Constraint {
    /** unique or primary key constraint on columns "timestamp", "validator_address" */
...
export type Proposal_Deposit_Bool_Exp = {
    ...
    amount?: Maybe<Coin_Array_Comparison_Exp>;
...
export enum Proposal_Deposit_Constraint {
    /** unique or primary key constraint on columns "depositor_address", "transaction_hash", "proposal_id" */
...
export enum Proposal_Vote_Constraint {
    /** unique or primary key constraint on columns "voter_address", "proposal_id", "option" */
...
export type Staking_Pool_Bool_Exp = {
    ...
    not_bonded_tokens?: Maybe<String_Comparison_Exp>;
    one_row_id?: Maybe<Boolean_Comparison_Exp>;
    staked_not_bonded_tokens?: Maybe<String_Comparison_Exp>;
    unbonding_tokens?: Maybe<String_Comparison_Exp>;
};
...
export type Staking_Pool_Order_By = {
    ...
    not_bonded_tokens?: Maybe<Order_By>;
    one_row_id?: Maybe<Order_By>;
    staked_not_bonded_tokens?: Maybe<Order_By>;
    unbonding_tokens?: Maybe<Order_By>;
};
...
export type Supply_Bool_Exp = {
    ...
    coins?: Maybe<Coin_Array_Comparison_Exp>;
    height?: Maybe<Bigint_Comparison_Exp>;
    one_row_id?: Maybe<Boolean_Comparison_Exp>;
};
...
export type Token_Unit_Bool_Exp = {
    ...
    aliases?: Maybe<String_Array_Comparison_Exp>;
...
export type Transaction_Bool_Exp = {
    ...
    messages?: Maybe<Json_Comparison_Exp>;
    partition_id?: Maybe<Bigint_Comparison_Exp>;
    raw_log?: Maybe<String_Comparison_Exp>;
    signatures?: Maybe<String_Array_Comparison_Exp>;
...
export type Vesting_Account_Bool_Exp = {
    ...
    id?: Maybe<Int_Comparison_Exp>;
    original_vesting?: Maybe<Coin_Array_Comparison_Exp>;
...
export type AccountCommissionQuery = {
    commission?: Maybe<{ __typename?: 'ActionValidatorCommissionAmount' } & Pick<ActionValidatorCommissionAmount, 'coins'>>;
};
...
export type AccountWithdrawalAddressQuery = { withdrawalAddress: { __typename?: 'ActionAddress' } & Pick<ActionAddress, 'address'> };

export type AccountBalancesQueryVariables = Exact<{
    address: Scalars['String'];
}>;

export type AccountBalancesQuery = { accountBalances?: Maybe<{ __typename?: 'ActionBalance' } & Pick<ActionBalance, 'coins'>> };

export type AccountDelegationBalanceQueryVariables = Exact<{
    address: Scalars['String'];
}>;

export type AccountDelegationBalanceQuery = { delegationBalance?: Maybe<{ __typename?: 'ActionBalance' } & Pick<ActionBalance, 'coins'>> };

export type AccountUnbondingBalanceQueryVariables = Exact<{
    address: Scalars['String'];
}>;

export type AccountUnbondingBalanceQuery = { unbondingBalance?: Maybe<{ __typename?: 'ActionBalance' } & Pick<ActionBalance, 'coins'>> };
...
export type AccountDelegationRewardsQuery = {
    delegationRewards?: Maybe<
        Array<
            Maybe<
                { __typename?: 'ActionDelegationReward' } & Pick<ActionDelegationReward, 'coins'> & {
...
export type AccountDelegationsQuery = {
    delegations?: Maybe<{ __typename?: 'ActionDelegationResponse' } & Pick<ActionDelegationResponse, 'delegations' | 'pagination'>>;
};
...
export type AccountRedelegationsQuery = {
    redelegations?: Maybe<{ __typename?: 'ActionRedelegationResponse' } & Pick<ActionRedelegationResponse, 'redelegations' | 'pagination'>>;
};
...
export type AccountUndelegationsQuery = {
    undelegations?: Maybe<
        { __typename?: 'ActionUnbondingDelegationResponse' } & Pick<ActionUnbondingDelegationResponse, 'pagination'> & {
...
export type ActiveValidatorCountQuery = {
    activeTotal: { __typename?: 'validator_status_aggregate' } & {
        aggregate?: Maybe<{ __typename?: 'validator_status_aggregate_fields' } & Pick<Validator_Status_Aggregate_Fields, 'count'>>;
    };
    inactiveTotal: { __typename?: 'validator_status_aggregate' } & {
        aggregate?: Maybe<{ __typename?: 'validator_status_aggregate_fields' } & Pick<Validator_Status_Aggregate_Fields, 'count'>>;
    };
    total: { __typename?: 'validator_status_aggregate' } & {
        aggregate?: Maybe<{ __typename?: 'validator_status_aggregate_fields' } & Pick<Validator_Status_Aggregate_Fields, 'count'>>;
    };
};
...
export type BlockDetailsQuery = {
    transaction: Array<{ __typename?: 'transaction' } & Pick<Transaction, 'height' | 'hash' | 'messages' | 'success' | 'logs'>>;
    block: Array<
        { __typename?: 'block' } & Pick<Block, 'height' | 'hash' | 'timestamp'> & { txs: Block['num_txs'] } & {
                validator?: Maybe<
                    { __typename?: 'validator' } & {
                        validatorInfo?: Maybe<{ __typename?: 'validator_info' } & { operatorAddress: Validator_Info['operator_address'] }>;
                    }
                >;
            }
    >;
    preCommitsAggregate: { __typename?: 'pre_commit_aggregate' } & {
        aggregate?: Maybe<
            { __typename?: 'pre_commit_aggregate_fields' } & {
                sum?: Maybe<{ __typename?: 'pre_commit_sum_fields' } & { votingPower: Pre_Commit_Sum_Fields['voting_power'] }>;
            }
        >;
    };
    preCommits: Array<
        { __typename?: 'pre_commit' } & {
            validator: { __typename?: 'validator' } & {
                validatorInfo?: Maybe<{ __typename?: 'validator_info' } & { operatorAddress: Validator_Info['operator_address'] }>;
            };
        }
    >;
...
export type LatestBlockHeightListenerSubscription = { height: Array<{ __typename?: 'block' } & Pick<Block, 'height'>> };

export type AverageBlockTimeQueryVariables = Exact<{ [key: string]: never }>;

export type AverageBlockTimeQuery = {
    averageBlockTime: Array<{ __typename?: 'average_block_time_per_hour' } & { averageTime: Average_Block_Time_Per_Hour['average_time'] }>;
};
...
export type LatestBlockTimestampQuery = { block: Array<{ __typename?: 'block' } & Pick<Block, 'timestamp'>> };
    ...
    blocks: Array<
        { __typename?: 'block' } & Pick<Block, 'height' | 'hash' | 'timestamp'> & { txs: Block['num_txs'] } & {
                validator?: Maybe<
                    { __typename?: 'validator' } & {
                        validatorInfo?: Maybe<
                            { __typename?: 'validator_info' } & Pick<Validator_Info, 'self_delegate_address'> & {
                                    operatorAddress: Validator_Info['operator_address'];
                                }
                        >;
                        validatorDescriptions: Array<
                            { __typename?: 'validator_description' } & Pick<Validator_Description, 'moniker' | 'identity'>
                        >;
                    }
                >;
            }
...
export type ChainIdQuery = { genesis: Array<{ __typename?: 'genesis' } & Pick<Genesis, 'time'> & { chainId: Genesis['chain_id'] }> };
...
export type MarketDataQuery = {
    communityPool: Array<{ __typename?: 'community_pool' } & Pick<Community_Pool, 'coins'>>;
    inflation: Array<{ __typename?: 'inflation' } & Pick<Inflation, 'value'>>;
    tokenPrice: Array<{ __typename?: 'token_price' } & Pick<Token_Price, 'price'> & { marketCap: Token_Price['market_cap'] }>;
    supply: Array<{ __typename?: 'supply' } & Pick<Supply, 'coins'>>;
    bondedTokens: Array<{ __typename?: 'staking_pool' } & Pick<Staking_Pool, 'bonded_tokens'>>;
    distributionParams: Array<{ __typename?: 'distribution_params' } & Pick<Distribution_Params, 'params'>>;
};
...
export type GetMessagesByAddressQuery = {
    messagesByAddress: Array<
        { __typename?: 'message' } & {
            transaction?: Maybe<
                { __typename?: 'transaction' } & Pick<Transaction, 'height' | 'hash' | 'success' | 'messages' | 'logs' | 'events'> & {
...
export type OnlineVotingPowerQuery = {
    ...
    validatorVotingPowerAggregate: { __typename?: 'validator_voting_power_aggregate' } & {
        aggregate?: Maybe<
            { __typename?: 'validator_voting_power_aggregate_fields' } & {
                sum?: Maybe<
                    { __typename?: 'validator_voting_power_sum_fields' } & {
    ...
    stakingPool: Array<{ __typename?: 'staking_pool' } & { bonded: Staking_Pool['bonded_tokens'] }>;
    stakingParams: Array<{ __typename?: 'staking_params' } & Pick<Staking_Params, 'params'>>;
};
...
export type ParamsQuery = {
    stakingParams: Array<{ __typename?: 'staking_params' } & Pick<Staking_Params, 'params'>>;
    slashingParams: Array<{ __typename?: 'slashing_params' } & Pick<Slashing_Params, 'params'>>;
    mintParams: Array<{ __typename?: 'mint_params' } & Pick<Mint_Params, 'params'>>;
    distributionParams: Array<{ __typename?: 'distribution_params' } & Pick<Distribution_Params, 'params'>>;
    govParams: Array<
        { __typename?: 'gov_params' } & {
            depositParams: Gov_Params['params'];
            tallyParams: Gov_Params['params'];
            votingParams: Gov_Params['params'];
        }
    >;
};
...
export type ProposalDetailsQuery = {
    proposal: Array<
        { __typename?: 'proposal' } & Pick<Proposal, 'title' | 'description' | 'status' | 'content'> & {
...
export type ProposalDetailsTallyQuery = {
    proposalTallyResult: Array<
        { __typename?: 'proposal_tally_result' } & Pick<Proposal_Tally_Result, 'yes' | 'no' | 'abstain'> & {
                noWithVeto: Proposal_Tally_Result['no_with_veto'];
            }
    >;
    stakingPool: Array<
        { __typename?: 'proposal_staking_pool_snapshot' } & { bondedTokens: Proposal_Staking_Pool_Snapshot['bonded_tokens'] }
    >;
    quorum: Array<{ __typename?: 'gov_params' } & { tallyParams: Gov_Params['params'] }>;
};
...
export type ProposalDetailsDepositsQuery = {
    proposalDeposit: Array<
        { __typename?: 'proposal_deposit' } & Pick<Proposal_Deposit, 'amount'> & {
                depositorAddress: Proposal_Deposit['depositor_address'];
            } & { block?: Maybe<{ __typename?: 'block' } & Pick<Block, 'timestamp'>> }
    >;
};
...
export type ProposalDetailsVotesQuery = {
    proposalVote: Array<
        { __typename?: 'proposal_vote' } & Pick<Proposal_Vote, 'option'> & { voterAddress: Proposal_Vote['voter_address'] }
    >;
    validatorStatuses: Array<
        { __typename?: 'proposal_validator_status_snapshot' } & {
            validator: { __typename?: 'validator' } & {
                validatorInfo?: Maybe<{ __typename?: 'validator_info' } & { selfDelegateAddress: Validator_Info['self_delegate_address'] }>;
            };
        }
    >;
};
...
export type ProposalsQuery = {
    proposals: Array<{ __typename?: 'proposal' } & Pick<Proposal, 'title' | 'status' | 'description'> & { proposalId: Proposal['id'] }>;
    total: { __typename?: 'proposal_aggregate' } & {
        aggregate?: Maybe<{ __typename?: 'proposal_aggregate_fields' } & Pick<Proposal_Aggregate_Fields, 'count'>>;
    };
};
...
export type TokenPriceHistoryQuery = {
    tokenPrice: Array<{ __typename?: 'token_price_history' } & Pick<Token_Price_History, 'price' | 'timestamp'>>;
};
...
export type TokenomicsQuery = {
    stakingParams: Array<{ __typename?: 'staking_params' } & Pick<Staking_Params, 'params'>>;
    stakingPool: Array<
        { __typename?: 'staking_pool' } & { bonded: Staking_Pool['bonded_tokens']; unbonded: Staking_Pool['not_bonded_tokens'] }
    >;
    supply: Array<{ __typename?: 'supply' } & Pick<Supply, 'coins'>>;
};
...
export type TransactionDetailsQuery = {
    transaction: Array<
        { __typename?: 'transaction' } & Pick<Transaction, 'logs' | 'events'> & {
            ...
            } & { block: { __typename?: 'block' } & { timestamp: Block['timestamp'] } }
    >;
};
...
export type LastHundredBlocksSubscription = {
    block: Array<
        { __typename?: 'block' } & Pick<Block, 'height'> & {
                validator?: Maybe<
                    { __typename?: 'validator' } & {
                        validatorInfo?: Maybe<{ __typename?: 'validator_info' } & { operatorAddress: Validator_Info['operator_address'] }>;
                    }
                >;
                transactions: Array<{ __typename?: 'transaction' } & Pick<Transaction, 'hash'>>;
                precommits: Array<{ __typename?: 'pre_commit' } & { validatorAddress: Pre_Commit['validator_address'] }>;
            }
    >;
};
...
export type ValidatorLastSeenListenerSubscription = {
    preCommit: Array<{ __typename?: 'pre_commit' } & Pick<Pre_Commit, 'height' | 'timestamp'>>;
};
...
export type ValidatorDetailsQuery = {
    stakingPool: Array<{ __typename?: 'staking_pool' } & Pick<Staking_Pool, 'height'> & { bonded: Staking_Pool['bonded_tokens'] }>;
    validator: Array<
        { __typename?: 'validator' } & {
            validatorDescriptions: Array<{ __typename?: 'validator_description' } & Pick<Validator_Description, 'details' | 'website'>>;
            validatorStatuses: Array<{ __typename?: 'validator_status' } & Pick<Validator_Status, 'status' | 'jailed' | 'height'>>;
            validatorSigningInfos: Array<
                { __typename?: 'validator_signing_info' } & Pick<Validator_Signing_Info, 'tombstoned'> & {
            ...
            validatorInfo?: Maybe<
                { __typename?: 'validator_info' } & {
                    ...
                    maxRate: Validator_Info['max_rate'];
                }
            >;
            validatorCommissions: Array<{ __typename?: 'validator_commission' } & Pick<Validator_Commission, 'commission'>>;
            validatorVotingPowers: Array<
                { __typename?: 'validator_voting_power' } & Pick<Validator_Voting_Power, 'height'> & {
...
export type ValidatorsQuery = {
    stakingPool: Array<{ __typename?: 'staking_pool' } & { bondedTokens: Staking_Pool['bonded_tokens'] }>;
    validator: Array<
        { __typename?: 'validator' } & {
            validatorStatuses: Array<{ __typename?: 'validator_status' } & Pick<Validator_Status, 'status' | 'jailed' | 'height'>>;
            validatorSigningInfos: Array<
            ...
            >;
            validatorVotingPowers: Array<
                { __typename?: 'validator_voting_power' } & { votingPower: Validator_Voting_Power['voting_power'] }
            >;
            validatorCommissions: Array<{ __typename?: 'validator_commission' } & Pick<Validator_Commission, 'commission'>>;
        }
    >;
        ...
        { __typename?: 'validator' } & {
            validatorInfo?: Maybe<
                { __typename?: 'validator_info' } & {
                    operatorAddress: Validator_Info['operator_address'];
                    selfDelegateAddress: Validator_Info['self_delegate_address'];
                    consensusAddress: Validator_Info['consensus_address'];
                }
            >;
            validatorDescriptions: Array<
                { __typename?: 'validator_description' } & Pick<Validator_Description, 'moniker' | 'identity'> & {
...
export type ValidatorAddressesQuery = {
    validator: Array<
        { __typename?: 'validator' } & {
            ...
            >;
            validatorDescriptions: Array<
                { __typename?: 'validator_description' } & Pick<Validator_Description, 'moniker'> & {
                        avatarUrl: Validator_Description['avatar_url'];
                    }
            >;
        }
...
export function useAccountCommissionLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<AccountCommissionQuery, AccountCommissionQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useAccountWithdrawalAddressQuery(
    baseOptions: Apollo.QueryHookOptions<AccountWithdrawalAddressQuery, AccountWithdrawalAddressQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<AccountWithdrawalAddressQuery, AccountWithdrawalAddressQueryVariables>(
        AccountWithdrawalAddressDocument,
        options
    );
}
export function useAccountWithdrawalAddressLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<AccountWithdrawalAddressQuery, AccountWithdrawalAddressQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useLazyQuery<AccountWithdrawalAddressQuery, AccountWithdrawalAddressQueryVariables>(
        AccountWithdrawalAddressDocument,
        options
    );
}
...
export function useAccountBalancesLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<AccountBalancesQuery, AccountBalancesQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useAccountDelegationBalanceQuery(
    baseOptions: Apollo.QueryHookOptions<AccountDelegationBalanceQuery, AccountDelegationBalanceQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<AccountDelegationBalanceQuery, AccountDelegationBalanceQueryVariables>(
        AccountDelegationBalanceDocument,
        options
    );
}
export function useAccountDelegationBalanceLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<AccountDelegationBalanceQuery, AccountDelegationBalanceQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useLazyQuery<AccountDelegationBalanceQuery, AccountDelegationBalanceQueryVariables>(
        AccountDelegationBalanceDocument,
        options
    );
}
 ...
 * });
 */
export function useAccountUnbondingBalanceQuery(
    baseOptions: Apollo.QueryHookOptions<AccountUnbondingBalanceQuery, AccountUnbondingBalanceQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useAccountUnbondingBalanceLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<AccountUnbondingBalanceQuery, AccountUnbondingBalanceQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useLazyQuery<AccountUnbondingBalanceQuery, AccountUnbondingBalanceQueryVariables>(
...
export function useAccountDelegationRewardsQuery(
    baseOptions: Apollo.QueryHookOptions<AccountDelegationRewardsQuery, AccountDelegationRewardsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<AccountDelegationRewardsQuery, AccountDelegationRewardsQueryVariables>(
        AccountDelegationRewardsDocument,
        options
    );
}
export function useAccountDelegationRewardsLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<AccountDelegationRewardsQuery, AccountDelegationRewardsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useLazyQuery<AccountDelegationRewardsQuery, AccountDelegationRewardsQueryVariables>(
        AccountDelegationRewardsDocument,
        options
    );
}
 ...
 * });
 */
export function useAccountDelegationsQuery(
    baseOptions: Apollo.QueryHookOptions<AccountDelegationsQuery, AccountDelegationsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<AccountDelegationsQuery, AccountDelegationsQueryVariables>(AccountDelegationsDocument, options);
}
export function useAccountDelegationsLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<AccountDelegationsQuery, AccountDelegationsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useAccountRedelegationsQuery(
    baseOptions: Apollo.QueryHookOptions<AccountRedelegationsQuery, AccountRedelegationsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<AccountRedelegationsQuery, AccountRedelegationsQueryVariables>(AccountRedelegationsDocument, options);
}
export function useAccountRedelegationsLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<AccountRedelegationsQuery, AccountRedelegationsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useAccountUndelegationsQuery(
    baseOptions: Apollo.QueryHookOptions<AccountUndelegationsQuery, AccountUndelegationsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<AccountUndelegationsQuery, AccountUndelegationsQueryVariables>(AccountUndelegationsDocument, options);
}
export function useAccountUndelegationsLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<AccountUndelegationsQuery, AccountUndelegationsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useActiveValidatorCountQuery(
    baseOptions?: Apollo.QueryHookOptions<ActiveValidatorCountQuery, ActiveValidatorCountQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useActiveValidatorCountLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<ActiveValidatorCountQuery, ActiveValidatorCountQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useLatestBlockHeightListenerSubscription(
    baseOptions?: Apollo.SubscriptionHookOptions<LatestBlockHeightListenerSubscription, LatestBlockHeightListenerSubscriptionVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useSubscription<LatestBlockHeightListenerSubscription, LatestBlockHeightListenerSubscriptionVariables>(
...
export function useLatestBlockTimestampQuery(
    baseOptions?: Apollo.QueryHookOptions<LatestBlockTimestampQuery, LatestBlockTimestampQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useLatestBlockTimestampLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<LatestBlockTimestampQuery, LatestBlockTimestampQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useBlocksListenerSubscription(
    baseOptions?: Apollo.SubscriptionHookOptions<BlocksListenerSubscription, BlocksListenerSubscriptionVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useGetMessagesByAddressQuery(
    baseOptions?: Apollo.QueryHookOptions<GetMessagesByAddressQuery, GetMessagesByAddressQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useGetMessagesByAddressLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<GetMessagesByAddressQuery, GetMessagesByAddressQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useProposalDetailsTallyQuery(
    baseOptions?: Apollo.QueryHookOptions<ProposalDetailsTallyQuery, ProposalDetailsTallyQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useProposalDetailsTallyLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<ProposalDetailsTallyQuery, ProposalDetailsTallyQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useProposalDetailsDepositsQuery(
    baseOptions?: Apollo.QueryHookOptions<ProposalDetailsDepositsQuery, ProposalDetailsDepositsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useProposalDetailsDepositsLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<ProposalDetailsDepositsQuery, ProposalDetailsDepositsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useProposalDetailsVotesQuery(
    baseOptions?: Apollo.QueryHookOptions<ProposalDetailsVotesQuery, ProposalDetailsVotesQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useProposalDetailsVotesLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<ProposalDetailsVotesQuery, ProposalDetailsVotesQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useTokenPriceListenerSubscription(
    baseOptions?: Apollo.SubscriptionHookOptions<TokenPriceListenerSubscription, TokenPriceListenerSubscriptionVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useSubscription<TokenPriceListenerSubscription, TokenPriceListenerSubscriptionVariables>(
...
export function useTransactionDetailsLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<TransactionDetailsQuery, TransactionDetailsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useTransactionsListenerSubscription(
    baseOptions?: Apollo.SubscriptionHookOptions<TransactionsListenerSubscription, TransactionsListenerSubscriptionVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useSubscription<TransactionsListenerSubscription, TransactionsListenerSubscriptionVariables>(
...
export function useLastHundredBlocksSubscription(
    baseOptions?: Apollo.SubscriptionHookOptions<LastHundredBlocksSubscription, LastHundredBlocksSubscriptionVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useSubscription<LastHundredBlocksSubscription, LastHundredBlocksSubscriptionVariables>(
        LastHundredBlocksDocument,
        options
    );
}
...
export function useValidatorLastSeenListenerSubscription(
    baseOptions?: Apollo.SubscriptionHookOptions<ValidatorLastSeenListenerSubscription, ValidatorLastSeenListenerSubscriptionVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useSubscription<ValidatorLastSeenListenerSubscription, ValidatorLastSeenListenerSubscriptionVariables>(
        ValidatorLastSeenListenerDocument,
        options
    );
}
...
export function useValidatorDelegationsQuery(
    baseOptions: Apollo.QueryHookOptions<ValidatorDelegationsQuery, ValidatorDelegationsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useValidatorDelegationsLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<ValidatorDelegationsQuery, ValidatorDelegationsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useValidatorRedelegationsQuery(
    baseOptions: Apollo.QueryHookOptions<ValidatorRedelegationsQuery, ValidatorRedelegationsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useValidatorRedelegationsLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<ValidatorRedelegationsQuery, ValidatorRedelegationsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useValidatorUndelegationsQuery(
    baseOptions: Apollo.QueryHookOptions<ValidatorUndelegationsQuery, ValidatorUndelegationsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useValidatorUndelegationsLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<ValidatorUndelegationsQuery, ValidatorUndelegationsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useValidatorsAddressListQuery(
    baseOptions?: Apollo.QueryHookOptions<ValidatorsAddressListQuery, ValidatorsAddressListQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useValidatorsAddressListLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<ValidatorsAddressListQuery, ValidatorsAddressListQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
...
export function useValidatorAddressesLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<ValidatorAddressesQuery, ValidatorAddressesQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
