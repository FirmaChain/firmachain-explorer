...
import { MsgCommunityPoolSpendProposal, MsgParameterChangeProposal, MsgSoftwareUpgradeProposal, MsgTextProposal } from '../..';
import { Categories } from '../types';

class MsgSubmitProposal {
    public category: Categories;
    public type: string;
    public content: MsgTextProposal | MsgSoftwareUpgradeProposal | MsgParameterChangeProposal | MsgCommunityPoolSpendProposal;
