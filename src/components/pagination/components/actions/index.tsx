...
const Actions: React.FC<{
    ...
    return (
        <ul className={classnames(className, classes.root)}>
            ...
            <li>
                <IconButton disableRipple className={classes.button} onClick={handleNextPage} disabled={disableNext} aria-label="next page">
                    <NextIcon />
                </IconButton>
            </li>
            <li className="last">
                <IconButton disableRipple className={classes.button} onClick={handleLastPage} disabled={disableNext} aria-label="last page">
                    <NextFastIcon />
                </IconButton>
            </li>
            {!!rowsPerPageOptions && (
                <li className={classes.tablet}>
                    <FormControl>
                        <Select className={classes.rowSelection} value={rowsPerPage} onChange={handleRowOptionChange} input={<InputBase />}>
